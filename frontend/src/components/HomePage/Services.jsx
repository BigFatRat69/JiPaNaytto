                    ...
                    <Col xs={12} md={6} lg={4} className="mb-4 p-2">
                        <Card className="service-card">
                            ...
                            <Card.Text>
                                ...
                                adipiscing elit. Sed magna erat, auctor a
                                fringilla ut, consectetur non felis.
                            </Card.Text>
                        </Card>
                    </Col>
                    <Col xs={12} md={6} lg={4} className="mb-4 p-2">
                    ...
                    <Carousel data-bs-theme="dark">
                        <Carousel.Item>
                            <img
                                ...
                                src="https://icolorpalette.com/download/solidcolorimage/edf1fe_solid_color_background_icolorpalette.png"
                            />
                            <Carousel.Caption>
                        ...
                        <Carousel.Item>
                            ...
                            <Carousel.Caption>
                                <h3>
                                    Rakennesuunnitelmien kolmannen osapuolten
                                    tarkastus
                                </h3>
                            </Carousel.Caption>
                        </Carousel.Item>
